...
public class PredictedProjectile : PredictedIdentity<ProjectileState>
{
    ...
    protected virtual void ApplyDamage()
    {
        ...
        var state = currentState;
        Entity ownerEntity = Entity.GetEntityByNetworkID(state.ownerId.Value, isServer);
        Entity targetEntity = null;
        
        if (state.targetId.HasValue)
        {
            targetEntity = Entity.GetEntityByNetworkID(state.targetId.Value, isServer);
        }
